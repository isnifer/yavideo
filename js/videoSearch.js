angular
  .module('yaSearch', [])
  .controller('Video', function($scope, $http){
  ...
  $scope.insertVimeo = function(id){
    ...
    player.innerHTML = '<iframe src="http://player.vimeo.com/video/'+ id +'?autoplay=1"width="560" height="315" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen autoplay></iframe>';
  };
  ...
  .controller('nextPage', function($scope){
